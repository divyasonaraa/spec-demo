<template>
  <form @submit.prevent="handleSubmit" class="space-y-6">
    ...
    <StepIndicator
      ...
      :current-step="formState.currentStep || 0"
    />
    ...
    <FormStep
      ...
      :title="isMultiStep ? currentStepConfig.title : undefined"
      ...
      >
        ...
        >
          <component
            ...
            :aria-describedby="getAriaDescribedby(field.name, field.helpText)"
    ...
    <div class="flex justify-between pt-4 border-t border-gray-200">
      <BaseButton
        v-if="isMultiStep && !multiStep?.isFirstStep"
        type="button"
        variant="secondary"
      ...
      <div class="flex gap-3">
        <BaseButton
          v-if="isMultiStep && !multiStep?.isLastStep"
          type="button"
          :disabled="!multiStep?.canProceed"
          @click="handleNext"
        >
          Next
        </BaseButton>
        <BaseButton
          v-else
          type="submit"
          :loading="formState.submitState === 'submitting'"
