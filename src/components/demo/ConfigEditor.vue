<template>
    <div class="space-y-4">
        <div>
            ...
            <textarea id="config-editor" v-model="configText" @input="handleInput"
                ...
                :class="{ 'border-error-500': hasError }" placeholder="Paste your JSON configuration here..." />
            ...
            <div v-else-if="validationResult" class="mt-2">
                ...
                <div v-else class="space-y-2">
                    ...
                    <ul v-if="validationResult.warnings && validationResult.warnings.length > 0"
                        class="list-disc list-inside text-sm text-yellow-700 space-y-1 ml-7 mt-2">
        ...
        <div class="flex gap-3">
            <BaseButton @click="loadSampleConfig" variant="secondary" size="sm">
                Load Sample
            </BaseButton>

            <BaseButton @click="formatJson" variant="ghost" size="sm">
                Format JSON
            </BaseButton>
        </div>
    </div>
