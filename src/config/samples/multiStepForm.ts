...
/**
 * Multi-step form sample configuration
 * Demonstrates a 3-step onboarding form with:
 * - Step 1: Personal Information
 * - Step 2: Contact Details
 * - Step 3: Preferences
 */
export const multiStepForm: FormConfig = {
    id: 'multi-step-onboarding',
    metadata: {
        title: 'User Onboarding',
        description: 'Complete the registration process in 3 easy steps',
        version: '1.0.0',
        tags: ['onboarding', 'registration', 'multi-step'],
    },
    steps: [
        {
            id: 'personal-info',
            ...
            fields: [
                ...
                },
                {
                    ...
                    helpText: 'Format: YYYY-MM-DD (e.g., 1990-01-15)',
                    validation: {
                        required: true,
                        requiredMessage: 'Date of birth is required',
                        pattern: '^\\d{4}-\\d{2}-\\d{2}$',
                        patternMessage: 'Please enter date in YYYY-MM-DD format',
                    },
                },
                {
                    name: 'gender',
            ...
            fields: [
                ...
                },
                {
                    ...
                    validation: {
                        ...
                        minLength: 10,
                        minLengthMessage: 'Address must be at least 10 characters',
                    },
                },
                {
                    name: 'country',
            ...
            fields: [
                {
                    ...
                    type: 'checkbox',
                    defaultValue: false,
                    helpText: 'Get updates about new features and promotions',
                },
                {
                    name: 'notifications',
                    ...
                    validation: {
                        required: true,
                        requiredMessage: 'Please select a notification preference',
                    },
                },
                {
                    name: 'interests',
                ...
                },
                {
                    ...
                    helpText: 'Optional - share your background and interests',
                    validation: {
                        maxLength: 500,
