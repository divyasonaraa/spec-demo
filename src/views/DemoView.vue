<template>
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        <router-link to="/docs" class="text-primary-600 hover:text-primary-700 font-medium">
                            📖 Documentation
                        </router-link>
            ...
            <div class="mb-6 border-b border-gray-200">
                <nav class="-mb-px flex space-x-8">
                    ...
                    <button @click="activeTab = 'multi-step'" :class="[
                        'py-4 px-1 border-b-2 font-medium text-sm',
                    ...
                    <button @click="activeTab = 'conditional'" :class="[
                        'py-4 px-1 border-b-2 font-medium text-sm',
                    ...
                    <button @click="activeTab = 'complex'" :class="[
                        'py-4 px-1 border-b-2 font-medium text-sm',
                        activeTab === 'complex'
                            ? 'border-primary-600 text-primary-600'
                            : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                    ...
                    <button @click="activeTab = 'custom'" :class="[
                        'py-4 px-1 border-b-2 font-medium text-sm',
                        activeTab === 'custom'
                            ? 'border-primary-600 text-primary-600'
                            : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button v-if="currentConfig" @click="downloadConfig"
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button v-if="currentConfig && Object.keys(formValues).length > 0" @click="showCurrentPayload"
                    ...
                    <FormRenderer v-else :key="`form-${activeTab}`" :config="currentConfig" @submit="handleFormSubmit"
        ...
        <PayloadPreview :show="showPayloadPreview" :payload="submittedPayload" @close="showPayloadPreview = false" />
    </div>
</template>
